# Derivation to create gradle dependencies
# copied from  https://github.com/status-im/status-react/ git commit 2c882e39fdf54823b9db94431f1a7f28bef930f9


{aapt2, gradle-dependencies-attrs }:
...
let
  ...
  deps = gradle-dependencies-attrs;
...
in makeOverridable stdenv.mkDerivation {
  name = "gradle-maven-dependencies";
  buildInputs = [ aapt2 ];
